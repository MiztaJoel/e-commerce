...
namespace AppleStores.Controllers
{
    public class ContactUsController : Controller
    {
		...
		public ActionResult ValidateCaptcha(FormCollection collection)
		{
			...
			const string secret = "6LemIpIpAAAAAG9xe0IVyr6e-2q4wpTFJFgA3K3i";
			...
			else
			{
				...
				db.SaveChanges();
				ViewBag.Message = "Your query has been submitted successfully. we will get back to you shortly!";
			}
